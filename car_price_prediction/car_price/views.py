...
def user_input(request):
    if request.method=='POST':
        ...
        if form.is_valid():
            make = form.clean_data['make']
            year = form.clean_data['year']
            engine_fuel_type = form.clean_data['engine_fuel_type']
            engine_hp = form.clean_data['engine_hp']
            engine_cylinders  = form.clean_data['engine_cylinders']
            transmission_type = form.clean_data['transmission_type']
            driven_wheels = form.clean_data['driven_wheels']
            number_of_doors = form.clean_data['number_of_doors']
            vehicle_size = form.clean_data['vehicle_size']
            vehicle_style = form.clean_data['vehicle_style']
            highway_mpg = form.clean_data['highway_mpg']
            city_mpg = form.clean_data['city_mpg']
            popularity =form.clean_data['popularity']
            ...
            CarPrice.objects.create(
                make=make, year=year, engine_fuel_type=engine_fuel_type, engine_hp=engine_hp ,engine_cylinders=engine_cylinders,
                            ...
                            vehicle_size = vehicle_size,vehicle_style = vehicle_style, highway_mpg=highway_mpg, city_mpg=city_mpg,popularity=popularity, price =prediction[0]
            )
            price_of_car = {
...
def show_results(request):
    prediction_results =CarPrice.objects.last().price
    context ={
